    ...
    <section>
      ...
      <div className="max-width my-20 px-4">
        ...
        <ul className="text-[#4f5d6e] mb-5">
            <h3 className="mb-3 text-[17px]">Payments are non-refundable. If you cancel your booking, we will impose cancellation charges as follows:</h3>
            <li className=" list-disc ml-8 text-[17px]">30 days or more prior to departure – no loss of your payment</li>
        ...
        <p className="text-[#4f5d6e] mb-5 text-[17px]">All cancellations must be in writing and be made by the person who submitted the booking form. Please send an email to your contact at the Company, with a copy to <a className="text-blue-500" href="mailto:patagoniaexpeditionss@gmail.com">patagoniaexpeditionss@gmail.com</a></p>
