    ...
    return (
        <div className='relative bg-black'>
            ...
            <div className='absolute top-0 flex justify-center items-center text-white flex-col h-full w-full px-0'>
                ...
                <p className='text-5xl md:text-5xl lg:text-[70px] text-center leading-normal font-bold lg:leading-tight tracking-2 Kaushan'>Explore Patagonia With <br /> <span className='stroke'>Patagonia Explore</span></p>
            </div>
