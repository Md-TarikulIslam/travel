  ...
  const handleSubmit = (event) => {
    ...
    fetch("https://patagonia-explore-server.vercel.app/api/create-review", {
      ...
      .then((data) => {
        ...
        // Optionally, you can set a flag or show a message to indicate successful submission
      })
      .catch((error) => {
        console.error("Error submitting review:", error.message);
        // Optionally, you can set a flag or show an error message
      });
  };
              ...
              <DialogBody>
                <div className="grid gap-8">
                  <div className="flex flex-col items-center">
                    ...
                    <Rating type="number" value={formData.rating} name="rating" onChange={handleRatingChange} />
                  </div>
                  <Textarea type="text" value={formData.review} name="review" onChange={handleInputChange} label="Message" />
                </div>
              </DialogBody>
