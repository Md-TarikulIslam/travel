...
import img7 from '../assets/images/gallery/21.jpg'
import img8 from '../assets/images/gallery/26.jpg'
import img9 from '../assets/images/gallery/9.jpg'
import img10 from '../assets/images/gallery/23.jpg'
import img11 from '../assets/images/gallery/24.jpg'
import img12 from '../assets/images/gallery/12.jpg'
import img13 from '../assets/images/gallery/25.jpg'
...
import img21 from '../assets/images/gallery/27.jpg'
import img22 from '../assets/images/gallery/28.jpg'
import img23 from '../assets/images/gallery/29.jpg'
import img24 from '../assets/images/gallery/30.jpg'
import img25 from '../assets/images/gallery/31.jpg'
import img26 from '../assets/images/gallery/32.jpg'
import img27 from '../assets/images/gallery/33.jpg'
import img28 from '../assets/images/gallery/34.jpg'
import img29 from '../assets/images/gallery/35.jpg'
import img30 from '../assets/images/gallery/36.jpg'
const ImageGallery = () => {
    return (
        <section className='max-width grid grid-cols-1 gap-8'>
            ...
            <div className='grid md:grid-cols-3 grid-cols-1 gap-8'>
                <div className='flex-1 sm:max-h-[250px] overflow-hidden bg-black'>
            ...
            <div className='grid md:grid-cols-3 grid-cols-1 gap-8'>
                <div className='flex-1 sm:max-h-[250px] overflow-hidden bg-black'>
                <img className='hover:scale-105 hover:opacity-90 duration-300' src={img21} alt="" />
                </div>
                <div className='flex-1 sm:max-h-[250px] max-h-[350px] overflow-hidden bg-black'>
                <img className='hover:scale-105 hover:opacity-90 duration-300' src={img22} alt="" />
                </div>
                <div className='flex-1 sm:max-h-[250px] overflow-hidden bg-black'>
                <img className='hover:scale-105 hover:opacity-90 duration-300' src={img23} alt="" />
                </div>
            </div>
            <div className='grid md:grid-cols-2 grid-cols-1 gap-8'>
               <div className='flex-1 max-h-[400px] overflow-hidden bg-black'>
               <img className='hover:scale-105 hover:opacity-90 duration-300' src={img24} alt="" />
               </div>
                <div className='flex-1 max-h-[400px] overflow-hidden bg-black'>
                <img className='hover:scale-110 scale-105 hover:opacity-90 duration-300' src={img25} alt="" />
                </div>
            </div>
            <div className='grid md:grid-cols-3 grid-cols-1 gap-8'>
                <div className='flex-1 sm:max-h-[250px] overflow-hidden bg-black'>
                <img className='hover:scale-105 hover:opacity-90 duration-300' src={img26} alt="" />
                </div>
                <div className='flex-1 sm:max-h-[250px] max-h-[350px] overflow-hidden bg-black'>
                <img className='hover:scale-105 hover:opacity-90 duration-300' src={img27} alt="" />
                </div>
                <div className='flex-1 sm:max-h-[250px] overflow-hidden bg-black'>
                <img className='hover:scale-105 hover:opacity-90 duration-300' src={img28} alt="" />
                </div>
            </div>
            <div className='grid md:grid-cols-2 grid-cols-1 gap-8'>
               <div className='flex-1 max-h-[400px] overflow-hidden bg-black'>
               <img className='hover:scale-105 hover:opacity-90 duration-300' src={img29} alt="" />
               </div>
                <div className='flex-1 max-h-[400px] overflow-hidden bg-black'>
                <img className='hover:scale-110 scale-105 hover:opacity-90 duration-300' src={img30} alt="" />
                </div>
            </div>
        </section>
    );
