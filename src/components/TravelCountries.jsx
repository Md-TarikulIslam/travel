    ...
    return (
        <div className="max-width">
            ...
            >
                ...
                <SwiperSlide>   <div className="flex items-center flex-col lg:flex-row-reverse group">
                    <div>
                ...
                <SwiperSlide>  <div className="flex lg:flex-row flex-col items-center group">
                    <div className="z-20">
                        <img className="w-[45rem] h-[570px] lg:h-[29rem] lg:group-hover:scale-95 transition-all object-contain lg:object-cover object-top" src={img3} alt="" />
                    </div>
                    <Card className="z-30 rounded-none absolute right-0 -bottom-0 lg:bottom-12  lg:right-10 lg:h-[23rem] lg:w-[30rem] ">
                        <CardBody>
                            <p className="uppercase tracking-widest text-xs text-[#04afd1]">travel countries</p>
                            ...
                            <div className="grid grid-cols-3 sm:my-8 my-4 ">
                                <div>
                                    ...
                                    <p className="flex items-center gap-1 text-sm tracking-widest font-thin"><MdOutlineLocationOn className="text-[#04afd1] text-xl" />Rio de Janeiro</p>
                                </div>
                                <div>

                                    <p className="flex items-center gap-1 text-sm tracking-widest font-thin"><MdOutlineLocationOn className="text-[#04afd1] text-xl" />Foz do Iguacu</p>
                                </div>
                                <div>

                                    <p className="flex items-center gap-1 text-sm tracking-widest font-thin"><MdOutlineLocationOn className="text-[#04afd1] text-xl" />Salvador</p>
                                </div>
                            </div>
                            {/* <p className="border-b border-black"></p> */}
                            <div className="md:absolute lg:bottom-10 bottom-5">
